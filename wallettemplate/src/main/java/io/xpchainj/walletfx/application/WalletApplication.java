...
package io.xpchainj.walletfx.application;
...
import io.xpchainj.utils.AppDataDirectory;
...
public abstract class WalletApplication implements AppDelegate {
    ...
    protected void startWalletAppKit(Stage primaryStage) throws IOException {
        // Tell xpchainj to run event handlers on the JavaFX UI thread. This keeps things simple and means
    ...
    public void setupWalletKit(@Nullable DeterministicSeed seed) {
        ...
        walletAppKit = new WalletAppKit(params, preferredOutputScriptType, keyChainGroupStructure, appDataDirectory, walletFileName) {
            ...
            protected void onSetupCompleted() {
                Platform.runLater(controller::onXpchainSetup);
            }
        };
