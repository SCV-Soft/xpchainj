...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws io.xpchainj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws io.xpchainj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
