 ...
 * xpchainj performs cycle detection or not. Cycle detection is useful to detect bugs but comes with a small cost.
...
public class Threading {
     ...
     * xpchainj internally shouldn't normally run here, although currently there are a few exceptions.
     */
     ...
     * xpchainj library code is run, setting it after you started network traffic and other forms of processing
    ...
    static {
        ...
        // instantiating any xpchainj objects. The policy change will take effect only on new objects
