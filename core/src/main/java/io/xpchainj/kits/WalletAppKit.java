...
import io.xpchainj.net.discovery.DnsDiscovery;
...
import io.xpchainj.wallet.KeyChainGroup;
import io.xpchainj.wallet.KeyChainGroupStructure;
import io.xpchainj.wallet.Wallet;
import io.xpchainj.wallet.WalletExtension;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV xpchainj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit xpchainj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing xpchainj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * block sync faster for new users - please refer to the documentation on the xpchainj website
