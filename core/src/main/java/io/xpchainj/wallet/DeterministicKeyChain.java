...
import io.xpchainj.crypto.EncryptedData;
...
import io.xpchainj.crypto.LazyECPoint;
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from xpchainj users, but I've heard of cases via the grapevine of
