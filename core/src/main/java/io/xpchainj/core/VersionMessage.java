...
public class VersionMessage extends Message {
    ...
    public static final String XPCHAINJ_VERSION = "0.17-SNAPSHOT";
    /** The value that is prepended to the subVer field of this application. */
    public static final String LIBRARY_SUBVER = "/xpchainj:" + XPCHAINJ_VERSION + "/";
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for xpchainj
     * users might look like "/xpchainj:0.13/MultiBit:1.2/" where libraries come further to the left.</p>
     *
     ...
     * set of "/xpchainj:1.0/MultiBit:1.0(Windows)/". Therefore the / ( and ) characters are reserved in all these
