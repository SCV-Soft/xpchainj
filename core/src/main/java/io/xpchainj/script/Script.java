...
import io.xpchainj.core.SignatureDecodeException;
import io.xpchainj.core.Transaction;
import io.xpchainj.core.TransactionInput;
import io.xpchainj.core.TransactionOutput;
import io.xpchainj.core.TransactionWitness;
import io.xpchainj.core.UnsafeByteArrayOutputStream;
import io.xpchainj.core.Utils;
import io.xpchainj.core.VarInt;
import io.xpchainj.core.VerificationException;
import io.xpchainj.core.internal.InternalUtils;
import io.xpchainj.crypto.TransactionSignature;
...
import static io.xpchainj.script.ScriptOpCodes.OP_0;
import static io.xpchainj.script.ScriptOpCodes.OP_0NOTEQUAL;
import static io.xpchainj.script.ScriptOpCodes.OP_1;
import static io.xpchainj.script.ScriptOpCodes.OP_10;
import static io.xpchainj.script.ScriptOpCodes.OP_11;
import static io.xpchainj.script.ScriptOpCodes.OP_12;
import static io.xpchainj.script.ScriptOpCodes.OP_13;
import static io.xpchainj.script.ScriptOpCodes.OP_14;
import static io.xpchainj.script.ScriptOpCodes.OP_15;
import static io.xpchainj.script.ScriptOpCodes.OP_16;
import static io.xpchainj.script.ScriptOpCodes.OP_1ADD;
import static io.xpchainj.script.ScriptOpCodes.OP_1NEGATE;
import static io.xpchainj.script.ScriptOpCodes.OP_1SUB;
import static io.xpchainj.script.ScriptOpCodes.OP_2;
import static io.xpchainj.script.ScriptOpCodes.OP_2DIV;
import static io.xpchainj.script.ScriptOpCodes.OP_2DROP;
import static io.xpchainj.script.ScriptOpCodes.OP_2DUP;
import static io.xpchainj.script.ScriptOpCodes.OP_2MUL;
import static io.xpchainj.script.ScriptOpCodes.OP_2OVER;
import static io.xpchainj.script.ScriptOpCodes.OP_2ROT;
import static io.xpchainj.script.ScriptOpCodes.OP_2SWAP;
import static io.xpchainj.script.ScriptOpCodes.OP_3;
import static io.xpchainj.script.ScriptOpCodes.OP_3DUP;
import static io.xpchainj.script.ScriptOpCodes.OP_4;
import static io.xpchainj.script.ScriptOpCodes.OP_5;
import static io.xpchainj.script.ScriptOpCodes.OP_6;
import static io.xpchainj.script.ScriptOpCodes.OP_7;
import static io.xpchainj.script.ScriptOpCodes.OP_8;
import static io.xpchainj.script.ScriptOpCodes.OP_9;
import static io.xpchainj.script.ScriptOpCodes.OP_ABS;
import static io.xpchainj.script.ScriptOpCodes.OP_ADD;
import static io.xpchainj.script.ScriptOpCodes.OP_AND;
import static io.xpchainj.script.ScriptOpCodes.OP_BOOLAND;
import static io.xpchainj.script.ScriptOpCodes.OP_BOOLOR;
import static io.xpchainj.script.ScriptOpCodes.OP_CAT;
import static io.xpchainj.script.ScriptOpCodes.OP_CHECKLOCKTIMEVERIFY;
import static io.xpchainj.script.ScriptOpCodes.OP_CHECKMULTISIG;
import static io.xpchainj.script.ScriptOpCodes.OP_CHECKMULTISIGVERIFY;
import static io.xpchainj.script.ScriptOpCodes.OP_CHECKSEQUENCEVERIFY;
import static io.xpchainj.script.ScriptOpCodes.OP_CHECKSIG;
import static io.xpchainj.script.ScriptOpCodes.OP_CHECKSIGVERIFY;
import static io.xpchainj.script.ScriptOpCodes.OP_CODESEPARATOR;
import static io.xpchainj.script.ScriptOpCodes.OP_DEPTH;
import static io.xpchainj.script.ScriptOpCodes.OP_DIV;
import static io.xpchainj.script.ScriptOpCodes.OP_DROP;
import static io.xpchainj.script.ScriptOpCodes.OP_DUP;
import static io.xpchainj.script.ScriptOpCodes.OP_ELSE;
import static io.xpchainj.script.ScriptOpCodes.OP_ENDIF;
import static io.xpchainj.script.ScriptOpCodes.OP_EQUAL;
import static io.xpchainj.script.ScriptOpCodes.OP_EQUALVERIFY;
import static io.xpchainj.script.ScriptOpCodes.OP_FROMALTSTACK;
import static io.xpchainj.script.ScriptOpCodes.OP_GREATERTHAN;
import static io.xpchainj.script.ScriptOpCodes.OP_GREATERTHANOREQUAL;
import static io.xpchainj.script.ScriptOpCodes.OP_HASH160;
import static io.xpchainj.script.ScriptOpCodes.OP_HASH256;
import static io.xpchainj.script.ScriptOpCodes.OP_IF;
import static io.xpchainj.script.ScriptOpCodes.OP_IFDUP;
import static io.xpchainj.script.ScriptOpCodes.OP_INVALIDOPCODE;
import static io.xpchainj.script.ScriptOpCodes.OP_INVERT;
import static io.xpchainj.script.ScriptOpCodes.OP_LEFT;
import static io.xpchainj.script.ScriptOpCodes.OP_LESSTHAN;
import static io.xpchainj.script.ScriptOpCodes.OP_LESSTHANOREQUAL;
import static io.xpchainj.script.ScriptOpCodes.OP_LSHIFT;
import static io.xpchainj.script.ScriptOpCodes.OP_MAX;
import static io.xpchainj.script.ScriptOpCodes.OP_MIN;
import static io.xpchainj.script.ScriptOpCodes.OP_MOD;
import static io.xpchainj.script.ScriptOpCodes.OP_MUL;
import static io.xpchainj.script.ScriptOpCodes.OP_NEGATE;
import static io.xpchainj.script.ScriptOpCodes.OP_NIP;
import static io.xpchainj.script.ScriptOpCodes.OP_NOP;
import static io.xpchainj.script.ScriptOpCodes.OP_NOP1;
import static io.xpchainj.script.ScriptOpCodes.OP_NOP10;
import static io.xpchainj.script.ScriptOpCodes.OP_NOP4;
import static io.xpchainj.script.ScriptOpCodes.OP_NOP5;
import static io.xpchainj.script.ScriptOpCodes.OP_NOP6;
import static io.xpchainj.script.ScriptOpCodes.OP_NOP7;
import static io.xpchainj.script.ScriptOpCodes.OP_NOP8;
import static io.xpchainj.script.ScriptOpCodes.OP_NOP9;
import static io.xpchainj.script.ScriptOpCodes.OP_NOT;
import static io.xpchainj.script.ScriptOpCodes.OP_NOTIF;
import static io.xpchainj.script.ScriptOpCodes.OP_NUMEQUAL;
import static io.xpchainj.script.ScriptOpCodes.OP_NUMEQUALVERIFY;
import static io.xpchainj.script.ScriptOpCodes.OP_NUMNOTEQUAL;
import static io.xpchainj.script.ScriptOpCodes.OP_OR;
import static io.xpchainj.script.ScriptOpCodes.OP_OVER;
import static io.xpchainj.script.ScriptOpCodes.OP_PICK;
import static io.xpchainj.script.ScriptOpCodes.OP_PUSHDATA1;
import static io.xpchainj.script.ScriptOpCodes.OP_PUSHDATA2;
import static io.xpchainj.script.ScriptOpCodes.OP_PUSHDATA4;
import static io.xpchainj.script.ScriptOpCodes.OP_RETURN;
import static io.xpchainj.script.ScriptOpCodes.OP_RIGHT;
import static io.xpchainj.script.ScriptOpCodes.OP_RIPEMD160;
import static io.xpchainj.script.ScriptOpCodes.OP_ROLL;
import static io.xpchainj.script.ScriptOpCodes.OP_ROT;
import static io.xpchainj.script.ScriptOpCodes.OP_RSHIFT;
import static io.xpchainj.script.ScriptOpCodes.OP_SHA1;
import static io.xpchainj.script.ScriptOpCodes.OP_SHA256;
import static io.xpchainj.script.ScriptOpCodes.OP_SIZE;
import static io.xpchainj.script.ScriptOpCodes.OP_SUB;
import static io.xpchainj.script.ScriptOpCodes.OP_SUBSTR;
import static io.xpchainj.script.ScriptOpCodes.OP_SWAP;
import static io.xpchainj.script.ScriptOpCodes.OP_TOALTSTACK;
import static io.xpchainj.script.ScriptOpCodes.OP_TUCK;
import static io.xpchainj.script.ScriptOpCodes.OP_VERIFY;
import static io.xpchainj.script.ScriptOpCodes.OP_WITHIN;
import static io.xpchainj.script.ScriptOpCodes.OP_XOR;
