...
public final class PeerSeedProtos {
  ...
  bitField0_ |= 0x00000001;
    ...
    public static PeerSeedProtos.PeerSeedData parseFrom(
    ...
    public static PeerSeedProtos.PeerSeedData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(PeerSeedProtos.PeerSeedData prototype) {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          PeerSeedProtos.PeerSeedData, Builder> implements
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new PeerSeedProtos.PeerSeedData();
        }
        case NEW_BUILDER: {
          return new Builder();
        }
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<PeerSeedProtos.PeerSeedData> parser = PARSER;
          if (parser == null) {
            synchronized (PeerSeedProtos.PeerSeedData.class) {
              parser = PARSER;
              if (parser == null) {
                parser =
                    new DefaultInstanceBasedParser<PeerSeedProtos.PeerSeedData>(
                        DEFAULT_INSTANCE);
                PARSER = parser;
              }
            }
    ...
    private static final PeerSeedProtos.PeerSeedData DEFAULT_INSTANCE;
    static {
  ...
  public  static final class PeerSeeds extends
    ...
    private com.google.protobuf.Internal.ProtobufList<PeerSeedProtos.PeerSeedData> seed_;
    /**
     * <code>repeated .org.bitcoin.crawler.PeerSeedData seed = 1;</code>
     */
    @java.lang.Override
     ...
     * <code>repeated .org.bitcoin.crawler.PeerSeedData seed = 1;</code>
     */
    public java.util.List<? extends PeerSeedProtos.PeerSeedDataOrBuilder>
     ...
     * <code>repeated .org.bitcoin.crawler.PeerSeedData seed = 1;</code>
     */
    public PeerSeedProtos.PeerSeedDataOrBuilder getSeedOrBuilder(
        int index) {
      return seed_.get(index);
    }
    private void ensureSeedIsMutable() {
      com.google.protobuf.Internal.ProtobufList<PeerSeedProtos.PeerSeedData> tmp = seed_;
      if (!tmp.isModifiable()) {
        seed_ =
    ...
    private void setSeed(
        int index, PeerSeedProtos.PeerSeedData value) {
      value.getClass();
  ensureSeedIsMutable();
     ...
     * <code>repeated .org.bitcoin.crawler.PeerSeedData seed = 1;</code>
     */
    private void addSeed(PeerSeedProtos.PeerSeedData value) {
      value.getClass();
  ensureSeedIsMutable();
      seed_.add(value);
    }
  ...
  ensureSeedIsMutable();
    ...
    private void addAllSeed(
        java.lang.Iterable<? extends PeerSeedProtos.PeerSeedData> values) {
      ensureSeedIsMutable();
  ...
  bitField0_ |= 0x00000002;
    ...
    public static PeerSeedProtos.PeerSeeds parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    ...
    public static PeerSeedProtos.PeerSeeds parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input, extensionRegistry);
    ...
    public static Builder newBuilder(PeerSeedProtos.PeerSeeds prototype) {
      return (Builder) DEFAULT_INSTANCE.createBuilder(prototype);
    }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          PeerSeedProtos.PeerSeeds, Builder> implements
       ...
       */
      public Builder setSeed(
          int index, PeerSeedProtos.PeerSeedData.Builder builderForValue) {
        copyOnWrite();
       ...
       * <code>repeated .org.bitcoin.crawler.PeerSeedData seed = 1;</code>
       */
      public Builder addSeed(PeerSeedProtos.PeerSeedData value) {
        copyOnWrite();
       ...
       */
      public Builder addSeed(
          PeerSeedProtos.PeerSeedData.Builder builderForValue) {
        copyOnWrite();
      ...
      switch (method) {
        ...
        case BUILD_MESSAGE_INFO: {
            java.lang.Object[] objects = new java.lang.Object[] {
              "bitField0_",
              "seed_",
              PeerSeedProtos.PeerSeedData.class,
              "timestamp_",
              "net_",
            };
            java.lang.String info =
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<PeerSeedProtos.PeerSeeds> parser = PARSER;
          if (parser == null) {
            synchronized (PeerSeedProtos.PeerSeeds.class) {
              parser = PARSER;
              if (parser == null) {
                parser =
                    new DefaultInstanceBasedParser<PeerSeedProtos.PeerSeeds>(
                        DEFAULT_INSTANCE);
                PARSER = parser;
              }
            }
  ...
  bitField0_ |= 0x00000004;
    ...
    public static PeerSeedProtos.SignedPeerSeeds parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    ...
    public static PeerSeedProtos.SignedPeerSeeds parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input, extensionRegistry);
    ...
    public static Builder newBuilder(PeerSeedProtos.SignedPeerSeeds prototype) {
      return (Builder) DEFAULT_INSTANCE.createBuilder(prototype);
    }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          PeerSeedProtos.SignedPeerSeeds, Builder> implements
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new PeerSeedProtos.SignedPeerSeeds();
        }
        case NEW_BUILDER: {
          return new Builder();
        }
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<PeerSeedProtos.SignedPeerSeeds> parser = PARSER;
          if (parser == null) {
            synchronized (PeerSeedProtos.SignedPeerSeeds.class) {
              parser = PARSER;
              if (parser == null) {
                parser =
                    new DefaultInstanceBasedParser<PeerSeedProtos.SignedPeerSeeds>(
                        DEFAULT_INSTANCE);
                PARSER = parser;
              }
            }
    ...
    private static final PeerSeedProtos.SignedPeerSeeds DEFAULT_INSTANCE;
    static {
