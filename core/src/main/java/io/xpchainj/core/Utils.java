 ...
 * To enable debug logging from the library, run with -Dxpchainj.logging=true on your command line.
 */
public class Utils {
     ...
     * forces xpchainj to try to allocate a huge piece of the memory resulting in OutOfMemoryError.
    */
