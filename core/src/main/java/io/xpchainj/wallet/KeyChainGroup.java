...
public class KeyChainGroup implements KeyBag {
    ...
    public static class Builder {
         ...
         * chain. This behaviour will likely be changed with xpchainj 0.16 such that only a P2WPKH chain is created and
         * activated.</p>
     ...
     * @see io.xpchainj.wallet.MarriedKeyChain
     */
     ...
     *
     * @throws io.xpchainj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     *
     * @throws io.xpchainj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
