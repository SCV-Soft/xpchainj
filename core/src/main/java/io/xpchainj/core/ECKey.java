...
import io.xpchain.NativeSecp256k1;
import io.xpchain.NativeSecp256k1Util;
import io.xpchain.Secp256k1Context;
import io.xpchainj.crypto.EncryptableItem;
...
public class ECKey implements EncryptableItem {
     ...
     * @throws io.xpchainj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * @throws io.xpchainj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
