...
import io.xpchainj.crypto.HDPath;
...
import io.xpchainj.crypto.MnemonicException;
...
import io.xpchainj.store.MemoryBlockStore;
import io.xpchainj.testing.FakeTxBuilder;
import io.xpchainj.testing.KeyChainTransactionSigner;
import io.xpchainj.testing.MockTransactionBroadcaster;
import io.xpchainj.testing.NopTransactionSigner;
import io.xpchainj.testing.TestWithWallet;
...
import static io.xpchainj.core.Coin.COIN;
import static io.xpchainj.core.Coin.MILLICOIN;
import static io.xpchainj.core.Coin.SATOSHI;
import static io.xpchainj.core.Coin.ZERO;
import static io.xpchainj.core.Coin.valueOf;
import static io.xpchainj.core.Utils.HEX;
import static io.xpchainj.testing.FakeTxBuilder.createFakeBlock;
import static io.xpchainj.testing.FakeTxBuilder.createFakeTx;
import static io.xpchainj.testing.FakeTxBuilder.createFakeTxWithoutChangeAddress;
import static io.xpchainj.testing.FakeTxBuilder.makeSolvedTestBlock;
import static io.xpchainj.testing.FakeTxBuilder.roundTripTransaction;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: xpchainj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("xpchainj-unit-test", null);
