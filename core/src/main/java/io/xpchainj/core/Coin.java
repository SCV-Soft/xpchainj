...
public final class Coin implements Monetary, Comparable<Coin>, Serializable {
    ...
    /**
     * 0.001 Bitcoins, also known as 1 mXPC.
     */
    public static final Coin MILLICOIN = COIN.divide(1000);

    /**
     * 0.000001 Bitcoins, also known as 1 µXPC or 1 uXPC.
     */
    ...
    /**
     * Convert a decimal amount of XPC into satoshis.
     *
    ...
    /**
     * Convert an amount in satoshis to an amount in XPC.
     *
     * @param satoshis number of satoshis
     * @return number of bitcoins (in XPC)
     */
    ...
    /**
     * Create a {@code Coin} from a decimal amount of XPC.
     *
     * @param coins number of coins (in XPC)
     * @return {@code Coin} object containing value in satoshis
     */
    ...
    /**
     * Convert to number of bitcoin (in XPC)
     *
     * @return decimal number of bitcoin (in XPC)
     */
    ...
    /**
     * <p>
     * Returns the value as a plain string denominated in XPC.
     * The result is unformatted with no trailing zeroes.
     * For instance, a value of 150000 satoshis gives an output string of "0.0015" XPC
     * </p>
     */
