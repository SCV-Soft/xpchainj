...
import io.xpchainj.core.listeners.BlockchainDownloadEventListener;
import io.xpchainj.core.listeners.BlocksDownloadedEventListener;
import io.xpchainj.core.listeners.ChainDownloadStartedEventListener;
import io.xpchainj.core.listeners.DownloadProgressTracker;
import io.xpchainj.core.listeners.GetDataEventListener;
import io.xpchainj.core.listeners.OnTransactionBroadcastListener;
...
import io.xpchainj.core.listeners.PeerDiscoveredEventListener;
import io.xpchainj.core.listeners.PreMessageReceivedEventListener;
import io.xpchainj.net.ClientConnectionManager;
import io.xpchainj.net.FilterMerger;
import io.xpchainj.net.NioClientManager;
import io.xpchainj.net.discovery.MultiplexingDiscovery;
import io.xpchainj.net.discovery.PeerDiscovery;
import io.xpchainj.net.discovery.PeerDiscoveryException;
...
import io.xpchainj.utils.ExponentialBackoff;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of xpchainj fixes the known
