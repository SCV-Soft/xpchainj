 ...
 * After bitcoind is up and running, use command: io.xpchainj.examples.FetchBlock --localhost &lt;blockHash&gt; </p>
 * <p>Otherwise, use command: io.xpchainj.examples.FetchBlock &lt;blockHash&gt;, this command will download blocks from a peer generated by DNS seeds.</p>
 */
...
public class FetchBlock implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        peerGroup.start();
        //System.out.println("END__::peerGroup.start()");
        //System.out.println("START::peerGroup.waitForPeers(1).get()");
        peerGroup.waitForPeers(1).get();
        //System.out.println("END__::peerGroup.waitForPeers(1).get()");
        //System.out.println("START::peerGroup.getConnectedPeers().get(0)");
        Peer peer = peerGroup.getConnectedPeers().get(0);
        //System.out.println("END__::peerGroup.getConnectedPeers().get(0)");
