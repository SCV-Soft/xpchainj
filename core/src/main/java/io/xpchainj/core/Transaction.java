...
import io.xpchainj.script.ScriptError;
import io.xpchainj.script.ScriptException;
import io.xpchainj.script.ScriptOpCodes;
...
import static io.xpchainj.core.NetworkParameters.ProtocolVersion.WITNESS_VERSION;
import static io.xpchainj.core.Utils.uint32ToByteStreamLE;
import static io.xpchainj.core.Utils.uint64ToByteStreamLE;
...
public class Transaction extends ChildMessage {
     ...
     */
    public static final Coin REFERENCE_DEFAULT_MIN_TX_FEE = Coin.valueOf(1000); // 0.01 mXPC

    /**
     * If using this feePerKb, transactions will get confirmed within the next couple of blocks.
     * This should be adjusted from time to time. Last adjustment: February 2017.
     */
    public static final Coin DEFAULT_TX_FEE = Coin.valueOf(100000); // 1 mXPC
