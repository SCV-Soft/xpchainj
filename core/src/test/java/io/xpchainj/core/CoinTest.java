...
import static io.xpchainj.core.Coin.NEGATIVE_SATOSHI;
import static io.xpchainj.core.Coin.SATOSHI;
import static io.xpchainj.core.Coin.ZERO;
import static io.xpchainj.core.Coin.btcToSatoshi;
import static io.xpchainj.core.Coin.parseCoin;
import static io.xpchainj.core.Coin.parseCoinInexact;
import static io.xpchainj.core.Coin.satoshiToBtc;
...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 XPC", COIN.toFriendlyString());
        assertEquals("1.23 XPC", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 XPC", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 XPC", valueOf(1, 23).negate().toFriendlyString());
    }
