...
package io.xpchainj.walletfx.utils;
...
/**
 * A class that exposes relevant xpchain stuff as JavaFX bindable properties.
 */
public class XpchainUIModel {
    ...
    public XpchainUIModel() {
    }

    public XpchainUIModel(Wallet wallet) {
        setWallet(wallet);
    }
