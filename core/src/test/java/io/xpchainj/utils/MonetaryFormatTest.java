...
public class MonetaryFormatTest {
    ...
    public void standardCodes() {
        assertEquals("XPC 0.00", MonetaryFormat.BTC.format(Coin.ZERO).toString());
        assertEquals("mXPC 0.00", MonetaryFormat.MBTC.format(Coin.ZERO).toString());
        assertEquals("µXPC 0", MonetaryFormat.UBTC.format(Coin.ZERO).toString());
