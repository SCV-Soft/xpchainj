...
# Change this to point to where you have a copy of the xpchainj.jar
sys.path.append(r"/path/to/xpchainj-core-0.12-bundled.jar")
...
if __name__ == "__main__":
    params = io.xpchainj.params.TestNet3Params.get()
