...
import io.xpchainj.store.PostgresFullPrunedBlockStore;
...
public class PostgresFullPrunedBlockChainTest extends AbstractFullPrunedBlockChainTest
{
    ...
    // You can set up a fresh postgres with the command: create user xpchainj superuser password 'password';
    private static final String DB_HOSTNAME = "localhost";
    private static final String DB_NAME = "xpchainj_test";
    private static final String DB_USERNAME = "xpchainj";
