...
package io.xpchainj.examples;

import io.xpchainj.core.*;
import io.xpchainj.kits.WalletAppKit;
...
/**
 * The following example shows how to use the by xpchainj provided WalletAppKit.
 * The WalletAppKit class wraps the boilerplate (Peers, BlockChain, BlockStorage, Wallet) needed to set up a new SPV xpchainj app.
 * 
...
public class Kit {
    ...
    public static void main(String[] args) {
        ...
        // 
        // For more information have a look at: https://xpchainj.github.io/testing and https://bitcoin.org/en/developer-examples#testing-applications
        ...
        // Have a look at the WalletAppKit documentation and its source to understand what's happening behind the scenes: https://github.com/bitcoinj/bitcoinj/blob/master/core/src/main/java/io/xpchainj/kits/WalletAppKit.java
        ...
        // xpchainj is working a lot with the Google Guava libraries. The WalletAppKit extends the AbstractIdleService. Have a look at the introduction to Guava services: https://github.com/google/guava/wiki/ServiceExplained
        kit.startAsync();
        kit.awaitRunning();
