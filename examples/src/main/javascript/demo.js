...
// This file shows how to use xpchainj from Javascript.
// To run, grab the xpchainj bundled JAR and then do something like this:
//
//   jjs -cp xpchainj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp xpchainj-0.12-bundled.jar
//
...
//
//   jjs -cp xpchainj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And xpchainj is a threaded library. This means you
