...
import io.xpchainj.core.BitcoinSerializer;
 ...
 */
public abstract class AbstractXpchainNetParams extends NetworkParameters {
    ...
    private static final Logger log = LoggerFactory.getLogger(AbstractXpchainNetParams.class);
     ...
     * No-args constructor
     */
    public AbstractXpchainNetParams() {
        super();
        interval = INTERVAL;
