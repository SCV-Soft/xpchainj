...
import static io.xpchainj.core.Sha256Hash.hashTwice;

/**
 * <p>A block is a group of transactions, and is one of the fundamental data structures of the Xpchain system.
...
public class Block extends Message {
    ...
    static final long ALLOWED_TIME_DRIFT = 2 * 60 * 60; // Same value as Xpchain Core.
    ...
    /** @deprecated Use {@link AbstractXpchainNetParams#getBlockInflation(int)} */
    @Deprecated
    public Coin getBlockInflation(int height) {
        return ((AbstractXpchainNetParams) params).getBlockInflation(height);
    }
    ...
    /**
     * Create a block sending 50XPC as a coinbase transaction to the public key specified.
