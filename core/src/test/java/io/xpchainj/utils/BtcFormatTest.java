...
import static io.xpchainj.core.Coin.SMALLEST_UNIT_EXPONENT;
...
import static io.xpchainj.core.NetworkParameters.MAX_MONEY;
import static io.xpchainj.utils.BtcAutoFormat.Style.CODE;
import static io.xpchainj.utils.BtcAutoFormat.Style.SYMBOL;
import static io.xpchainj.utils.BtcFixedFormat.REPEATING_DOUBLETS;
import static io.xpchainj.utils.BtcFixedFormat.REPEATING_TRIPLETS;
...
public class BtcFormatTest {
    ...
    public void parseTest() throws java.text.ParseException {
        ...
        // Coins
        assertEquals(valueOf(200000000), us.parseObject("XPC2"));
        ...
        assertEquals(valueOf(200000000), us.parseObject("2"));
        assertEquals(valueOf(200000000), usCoded.parseObject("XPC 2"));
        ...
        assertEquals(valueOf(200000000), us.parseObject("2.0"));
        assertEquals(valueOf(200000000), us.parseObject("XPC2.0"));
        ...
        assertEquals(valueOf(202222420000000L), us.parseObject("XPC2,022,224.20"));
        ...
        // MilliCoins
        assertEquals(valueOf(200000), usCoded.parseObject("mXPC 2"));
        ...
        assertEquals(valueOf(200000), us.parseObject("mXPC2"));
        ...
        assertEquals(valueOf(200000), us.parseObject("₥2"));
        assertEquals(valueOf(200000), usCoded.parseObject("₥XPC 2.00"));
        assertEquals(valueOf(200000), usCoded.parseObject("₥XBT 2.00"));
        assertEquals(valueOf(200000), usCoded.parseObject("₥XPC 2"));
        ...
        assertEquals(valueOf(202222400000L), us.parseObject("₥XPC2,022,224"));
        assertEquals(valueOf(202222400000L), us.parseObject("₥XBT2,022,224"));
        assertEquals(valueOf(202222400000L), us.parseObject("mXPC2,022,224"));
        ...
        assertEquals(valueOf(202222400000L), usCoded.parseObject("₥XPC 2,022,224"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("₥XBT 2,022,224"));
        assertEquals(valueOf(202222400000L), usCoded.parseObject("mXPC 2,022,224"));
        ...
        assertEquals(valueOf(435), us.parseObject("uXPC4.35"));
        assertEquals(valueOf(435), us.parseObject("uXBT4.35"));
        assertEquals(valueOf(435), us.parseObject("µXPC4.35"));
        assertEquals(valueOf(435), us.parseObject("µXBT4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("uXPC 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("uXBT 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("µXPC 4.35"));
        assertEquals(valueOf(435), usCoded.parseObject("µXBT 4.35"));
        // fractional satoshi; round up
        assertEquals(valueOf(435), us.parseObject("uXPC4.345"));
        ...
        assertEquals(valueOf(-10), us.parseObject("(µXPC0.100)"));
